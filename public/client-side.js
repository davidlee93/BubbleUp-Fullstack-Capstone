...
function displayNewBubble(data) {
  if (data.content.includes("https://www.youtube.com")) {
    ...
    let videoUrl = `[![${
      data.content
    }](http://img.youtube.com/vi/${videoID}/0.jpg)](http://www.youtube.com/watch?v=${videoID})`;
    $(".bubbles").prepend(
      `<div class="bubble col-xs-12">
            ...
            <div class="dialog" id="myform" tabindex="-1" data-backdrop="false">
                <form class="editForm">
                    ...
                    <input type="text" id="${
                      data.id
                    }" name="title" class="title col-xs-12" value="${
        data.title
      }">
                    </div>
                    ...
                    <input type="text" id="${
                      data.id
                    }" name="category" class="category col-xs-12" value="${
        data.category
      }">
                    </div>
                    <label for="content">Content:</label>
                    <textarea type="text" rows="4" cols="42" id="${
                      data.id
                    }" name="content" class="content col-xs-12">${
        data.content
      }</textarea>
                    <div align="center">
                        <input type="submit" value="Edit" class="btnOK" data-id="${
                          data.id
                        }">
        ...
        `<div class="bubble col-xs-12">
                ...
                <div class="dialog" id="myform" tabindex="-1" data-backdrop="false">
                    <form class="editForm">
                        ...
                        <br>
                        <a href="#" class="deleteBubble" data-id="${
                          data[index].id
                        }">
                        Delete
                        <i class="fas fa-trash-alt"></i>
